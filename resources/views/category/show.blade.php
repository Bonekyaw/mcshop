    ...
    <div class="row ">
        ...
        <div class="col-9 ">
          ...
          <p class="font-weight-bold h4 mt-3">
            ...
            <a href="/categories/{{$category->id}}/edit" class="h6 text-danger bg-warning ">Category အမည်ပြန်ပြောင်းလိုပါက</a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalCenterTitle">{{$category->category}} ကို ပယ်ဖျက်ခြင်း</h5>
